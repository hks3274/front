...
num += "sqrt(25) => " + Math.sqrt(25) + "<br/>";
num += "su3.toFixed(2) => " +su3.toFixed(2)+ "<br/>";

num += "Math.random() =>" + parseInt(Math.random()*10+1) +"<br/>";
num += "Math.random() =>" + parseInt(Math.random()*11+5) +"<br/>";
num += "Math.random() =>" + parseInt(Math.random()*45+1) +"<br/>";
